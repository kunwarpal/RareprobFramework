...
import com.rareprob.core_pulgin.payment.in_app_purchase.repository.IapDataRepository
...
@HiltViewModel
class InAppPurchaseViewModel @Inject constructor(application: Application,coreDatabase: CoreDatabase) :
    AndroidViewModel(application) {

    private val TAG = "InAppPurchaseViewModel"

    var billingClient: InAppBillingClientWrapper = InAppBillingClientWrapper(application,coreDatabase)

    private var repo: IapDataRepository =
        IapDataRepository(application, billingClient,coreDatabase)
