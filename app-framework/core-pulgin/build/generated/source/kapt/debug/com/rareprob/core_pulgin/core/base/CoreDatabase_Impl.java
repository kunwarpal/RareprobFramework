...
import com.rareprob.core_pulgin.payment.in_app_purchase.data.local.InAppPurchaseDao_Impl;
...
public final class CoreDatabase_Impl extends CoreDatabase {
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(InAppPurchaseDao.class, InAppPurchaseDao_Impl.getRequiredConverters());
    return _typeConvertersMap;
  }

  @Override
  public InAppPurchaseDao getInAppPurchaseDao() {
    if (_inAppPurchaseDao != null) {
      return _inAppPurchaseDao;
    } else {
      synchronized(this) {
        if(_inAppPurchaseDao == null) {
          _inAppPurchaseDao = new InAppPurchaseDao_Impl(this);
        }
        return _inAppPurchaseDao;
      }
    }
